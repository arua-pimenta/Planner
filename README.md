...
To keep our main page clean and readable, our extensive Changelog (tracking the evolution from the *Original Base Planner v0.1* up to our *LATEST MedPlanner builds*) was moved to a separate file.

👉 **[Read the Full CHANGELOG.md here!](./CHANGELOG.md)**

You can also find the bundled versions inside our [GitHub Releases Tab](https://github.com/arua-pimenta/planner/releases).
